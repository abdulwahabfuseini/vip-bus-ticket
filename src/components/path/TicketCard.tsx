...
const TicketCard = ({
  ...
  return (
    <div>
      ...
      >
        <div className="relative w-full h-24 overflow-hidden rounded-b-lg">
          <Image src="/images/kente3.png" alt="kente3" fill objectFit="cover" />
          <div className="py-2 px-3 flex gap-6 bg-black top-0 left-0 absolute w-full h-full bg-opacity-65 text-white rounded-b-lg">
            <button className="bg-slate-100 text-gray-500 rounded-full w-9 h-9 font-semibold text-lg">
              {id}
            </button>
            <div className="grid grid-cols-2  gap-y-3 pb-2 gap-x-4 flex-1">
